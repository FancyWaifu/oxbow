...
ROOT="/Users/5speeddeasil/oxbow";LOG="/tmp/pipe.log";PORT=45817
...
try:
 ...
 ok=cmd("oxtest","env stance test done",60)
 s=ser()[base:]
 print("=== ran (done-marker seen:",ok,") ===")
 for l in s.splitlines():
  t=l.strip()
  if any(k in t for k in("ok  -","FAIL","current_dir","current_exe","set_current_dir","read ","== env","fault","#UD","panic")):
   print(t)
finally:
 try:c("quit")
 except:pass
