...
int main(int argc, char **argv)
{
	...
	/* §maximize: DOOM provides NO .resize handler — it has a fixed 320x200 framebuffer,
	 * so on maximize the compositor upscales it (fullscreen game) instead of reflowing. */
	oxui_run(g_win, &h, 0);
	return 0;
}
